...
public class Worker_CompleteAddress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_complete_address);
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validateInputFields()) {
                    ...
                    // Prepare the address details to pass back to Worker_Registration activity
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (location != null) {
                    ...
                    new GeocodeAsyncTask(Worker_CompleteAddress.this).execute(location);
                }
            }
        };
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (e instanceof ResolvableApiException) {
                    try {
                        ...
                        resolvable.startResolutionForResult(Worker_CompleteAddress.this,
                                LOCATION_PERMISSION_REQUEST_CODE);
    ...
    private static class GeocodeAsyncTask extends AsyncTask<Location, Void, Address> {
        ...
        private WeakReference<Worker_CompleteAddress> activityReference;

        GeocodeAsyncTask(Worker_CompleteAddress activity) {
            activityReference = new WeakReference<>(activity);
        }

        @Override
        protected Address doInBackground(Location... locations) {
            Worker_CompleteAddress activity = activityReference.get();
